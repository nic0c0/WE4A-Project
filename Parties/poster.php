...
<div class="poster">
    <div class="img-container">
        <img id="blah" src="<?php echo (isset($post_data['post_img'])) ? $post_data['post_img'] : './IMG/img.png'; ?>"
            alt="Votre image" />
    </div>
    <form class="desc" action="./redirect.php" method="post" enctype="multipart/form-data">
        ...
        <div>
            ...
            <input type="text" id="post_title" name="post_title"
                value="<?php echo (isset($post_data['post_title']) ? $post_data['post_title'] : '') ?>" required>
            ...
            <textarea id="post_text" name="post_text" rows="5" cols="40"
                required><?php echo isset($post_data['post_text']) ? $post_data['post_text'] : ''; ?></textarea>
